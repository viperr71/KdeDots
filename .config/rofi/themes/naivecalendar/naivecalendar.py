...
# Locate
USER_LOCALE = "en_US.utf8" # keep empty to get system locale, use 'locale -a" on your system to list locales
...
PROMT_DATE_FORMAT = "%d %b %Y"
IS_TODAY_HEAD_MSG = False # toogle day num and name header display
...
def text_popup(head, body):
    ...
    win = tk.Tk()
    win.title(head)
    text_area = st.ScrolledText(win, width=50, height=12, font=("DejaVuSans ", 9))
